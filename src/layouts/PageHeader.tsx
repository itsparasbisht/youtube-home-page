    ...
    <div className="flex gap-10 lg:gap-20 justify-between pt-2 mb-6 mx-4">
      ...
      >
        ...
        <div className="flex flex-grow max-w-[600px]">
          ...
          />
          <Button className="py-1 px-4 rounded-r-full border border-secondary-border border-l-0 flex-shrink-0">
            <Search />
          </Button>
        </div>
      ...
      <div
        className={`${
          showFullWidthSearch ? "hidden" : "flex flex-shrink-0 md:gap-2"
        }`}
      >
        <Button
